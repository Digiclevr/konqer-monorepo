...
export default async function Page() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16">
      ...
      <h1 className="text-4xl font-bold tracking-tight">Calendar No-Show Shield</h1>
      <p className="mt-3 text-neutral-700">
        Reduce meeting no-shows with AI-powered engagement. Automated reminders and confirmation optimization.
      </p>
      ...
      <div className="mt-10 p-8 bg-white rounded-2xl border border-neutral-200 shadow-soft">
        ...
        <ul className="space-y-3 text-neutral-700">
          <li className="flex items-start">
            ...
            AI-optimized reminder sequences
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 mr-2">✓</span>
      ...
      <div className="mt-8 text-sm text-neutral-500">
        <a href={`${apiUrl}/services/calendar-no-show-shield`} target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">
          API Documentation →
        </a>
      </div>
    </main>
